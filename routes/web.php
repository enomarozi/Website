...
Route::GET('/profile/{username}/details/{properti}/{id}',[CariPropertyIndonesia::class,'details_profile'])->name('details_profile');
Route::GET('/profile/{username}/edit/{properti}/{id}',[CariPropertyIndonesia::class,'edit'])->name('edit')->middleware(('auth'));;
